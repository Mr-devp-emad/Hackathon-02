    ...
    <div>
      <div className='w-screen h-full flex flex-col justify-center items-center'>
        ...
        <div className='w-full h-[280px] flex justify-center items-center bg-white'> 
          <div className={`  w-[90%] max-w-[427px] h-[180px] flex flex-col justify-center items-center gap-4`}>
        ...
        <div className='w-screen h-full flex justify-center items-center bg-[#FAFAFA] px-4'>
          <div className='w-full max-w-[1050px] h-full flex flex-col justify-center items-center '>
            ...
            <div className={` w-[90%] max-w-[415px] h-[100px] gap-[10px] flex flex-col justify-center items-center `}>
            ...
            <div className={`  w-[90%] max-w-[311px] h-[44px] gap-[16px] flex justify-center items-center `}>
