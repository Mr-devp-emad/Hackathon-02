    ...
    <div>
                ...
                <div className='w-full md:w-[1018px] h-[188px] mx-auto flex flex-col md:flex-row justify-center items-center gap-[60px]'>
                    <div className='w-full h-[188px] flex justify-center items-center py-6 gap-20'>
                        <div className='w-full md:w-[394px] text-center md:text-left h-[140px] gap-6'>
                            <p className={` font-normal text-sm leading-5 text-[#E74040]`}>Problems trying</p>
                            <h3 className={` text-2xl font-bold leading-8 text-[#252B42]`} >Met minim Mollie non desert Alamo est sit cliquey dolor do met sent.</h3>
                        </div>
                    </div>
                    <div className='w-full md:w-[529px] h-10 gap-12'>
                        <p className={` font-normal text-center md:text-left text-sm leading-5 `}>Problems trying to resolve the conflict between the two major realms of Classical physics: Newtonian mechanics </p>
                    </div>
        ...
        <div className='w-screen h-[1006px] md:h-[264px] mt-10 md:mt-0 flex justify-center items-center '>
            <div className='w-[300px] md:w-[1050px] h-[806px] md:h-[264px] flex justify-center items-center py-20 gap-[50px] '>
                <div className={` w-[400px] md:w-[1050px] h-[716px] md:h-[104px] flex flex-col md:flex-row justify-between items-center gap-[30px]`} >
