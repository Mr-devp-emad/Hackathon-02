  ...
  return (
    <div>
        ...
        <div className='w-screen h-screen flex  md:mt-[28px] mt-0 z-9 justify-center items-center border '>
            ...
            <div className={`absolute w-[300px]  h-[550px] md:w-[599px] md:h-[331px] flex flex-col justify-center  text-center md:text-left md:bottom-0 md:top-80 md:left-56  gap-[35px] text-[#252B42] `}>
